...
class MovieCard extends HTMLElement{
  constructor(){
    ...
    setTimeout(() => {
      ...
      this.shadowRoot.querySelector(".button").href="https://imdb.com/title/"+this.getAttribute("imdbID")
  ...
  connectedCallback(){
    this.shadowRoot.querySelector(".isFavourite").addEventListener("click" ,()=>{
      this.favToggle()
    })
  }
